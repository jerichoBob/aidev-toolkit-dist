...
```bash
git clone git@github.com:jerichoBob/aidev-toolkit.git ~/.claude/aidev-toolkit
~/.claude/aidev-toolkit/scripts/install.sh
```
...
```bash
git clone https://github.com/jerichoBob/aidev-toolkit.git ~/.claude/aidev-toolkit
~/.claude/aidev-toolkit/scripts/install.sh
```
