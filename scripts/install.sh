...
echo -e "  ${YELLOW}/aid-login${NC}      Authenticate with GitHub"
...
echo -e "  ${YELLOW}/sdd-code${NC}           Implement all remaining tasks in a spec"
...
echo -e "  ${YELLOW}/aid-login${NC}      Log in with GitHub (opens browser → OAuth → stores JWT)"
echo ""
