...
- R6.x = Compliance
- R7.x = Integration
- R8.x = Operational (deep mode)
- R9.x = Organizational (deep mode)
- R10.x = Market/Business (deep mode)
-->

## Summary Statistics

- **Total Risks Identified**: {{TOTAL}}
- **High Severity (6-9)**: {{HIGH_COUNT}}
- **Medium Severity (3-4)**: {{MED_COUNT}}
- **Low Severity (1-2)**: {{LOW_COUNT}}
